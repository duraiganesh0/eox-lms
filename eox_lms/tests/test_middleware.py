...
from eox_lms.middleware import PathRedirectionMiddleware, RedirectionsMiddleware
from eox_lms.models import Redirection
...
class PathRedirectionMiddlewareTest(TestCase):
    ...
    @mock.patch('eox_lms.middleware.PathRedirectionMiddleware.process_mktg_redirect')
    @mock.patch('eox_lms.middleware.PathRedirectionMiddleware.process_custom_path_redirect')
    @mock.patch('eox_lms.middleware.configuration_helper')
...
class RedirectionMiddlewareTest(TestCase):
    ...
    @mock.patch('eox_lms.models.Redirection.objects.get')
