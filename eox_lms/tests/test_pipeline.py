...
from eox_lms.edxapp_wrapper.users import get_user_signup_source
from eox_lms.pipeline import (
...
class EnsureUserPasswordUsableTest(TestCase):
    ...
    @patch('eox_lms.pipeline.get_user_attribute')
...
class EnsureUserProfileTest(TestCase):
    ...
    @patch('eox_lms.edxapp_wrapper.users.import_module')
...
class SignupSourceRegistration(TestCase):
    ...
    @patch("eox_lms.pipeline.UserSignupSource")
    @patch("eox_lms.pipeline.get_current_request")
