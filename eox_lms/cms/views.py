...
from eox_lms.edxapp_wrapper.courses import (
    get_course_details_fields,
    get_courses_accessible_to_user,
    get_first_course_key,
    get_process_courses_list,
)
from eox_lms.edxapp_wrapper.edxmako_module import render_to_response
from eox_lms.edxapp_wrapper.users import get_course_team_user
...
def course_team(request, *args, **kwargs):  # pylint: disable=too-many-locals
    ...
    **Example Requests**:
        POST, DELETE <studio-url>/eox-lms/management/course-team-management
...
def get_courses_by_course_regex(request, *args, **kwargs):
    ...
    **Example Requests**:
        GET <studio-url>/eox-lms/management/get_courses?search=<query-string>
