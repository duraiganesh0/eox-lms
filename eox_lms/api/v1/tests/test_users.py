...
from eox_lms.api.v1.serializers import EdxappUserQuerySerializer, WrittableEdxappUserSerializer
...
class UsersUpdaterAPITest(TestCase):
    ...
    patch_permissions = patch('eox_lms.api.v1.permissions.EoxCoreAPIPermission.has_permission', return_value=True)
    ...
    @patch_permissions
    @patch('eox_lms.api.v1.serializers.UserSignupSource')
    @patch('eox_lms.api.v1.views.get_edxapp_user')
    @patch('eox_lms.api.v1.views.EdxappUserReadOnlySerializer')
...
class UsersAPITest(TestCase):
    ...
    @patch_permissions
    @patch('eox_lms.api.v1.serializers.check_edxapp_account_conflicts')
    @patch('eox_lms.api.v1.serializers.get_gender_choices')
    @patch('eox_lms.api.v1.serializers.get_level_of_education_choices')
    ...
    @patch('eox_lms.api.v1.serializers.get_gender_choices')
    @patch('eox_lms.api.v1.serializers.get_level_of_education_choices')
    @patch('eox_lms.api.v1.views.create_edxapp_user')
