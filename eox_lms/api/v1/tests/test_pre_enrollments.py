...
class PreEnrollmentsAPITest(TestCase):
    ...
    @patch('eox_lms.api.v1.views.get_pre_enrollment')
    ...
    @patch('eox_lms.api.v1.serializers.validate_org')
    @patch('eox_lms.api.v1.serializers.get_valid_course_key')
    @patch('eox_lms.api.v1.views.create_pre_enrollment')
    ...
    @patch('eox_lms.api.v1.serializers.get_valid_course_key')
    @patch('eox_lms.api.v1.views.get_pre_enrollment')
    @patch('eox_lms.api.v1.views.update_pre_enrollment')
    ...
    @patch('eox_lms.api.v1.serializers.get_valid_course_key')
    @patch('eox_lms.api.v1.views.get_pre_enrollment')
    @patch('eox_lms.api.v1.views.delete_pre_enrollment')
