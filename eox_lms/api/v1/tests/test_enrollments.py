...
class TestEnrollmentsAPI(TestCase):
    ...
    @patch('eox_lms.api.v1.views.get_enrollment')
    @patch('eox_lms.api.v1.views.get_edxapp_user')
    @patch_permissions
    ...
    @patch('eox_lms.api.v1.serializers.check_edxapp_enrollment_is_valid', )
    @patch_permissions
    ...
    @patch_permissions
    @patch('eox_lms.api.v1.serializers.validate_org')
    @patch('eox_lms.api.v1.serializers.get_valid_course_key')
    @patch('eox_lms.api.v1.serializers.check_edxapp_enrollment_is_valid', return_value=[])
    @patch('eox_lms.api.v1.views.get_edxapp_user')
    @patch('eox_lms.api.v1.views.create_enrollment')
    ...
    @patch('eox_lms.api.v1.serializers.check_edxapp_enrollment_is_valid', return_value=[])
    @patch('eox_lms.api.v1.views.get_edxapp_user')
    @patch('eox_lms.api.v1.views.update_enrollment')
    ...
    @patch_permissions
    @patch('eox_lms.api.v1.views.get_edxapp_user')
    @patch('eox_lms.api.v1.views.delete_enrollment')
