...
from eox_lms.api.v1.views import EdxappGrade
...
class TestGradesAPI(TestCase):
    ...
    patch_permissions = patch(
        "eox_lms.api.v1.permissions.EoxCoreAPIPermission.has_permission",
        return_value=True,
    )
    ...
    @patch("eox_lms.api.v1.views.get_courseware_courses")
    @patch("eox_lms.api.v1.views.get_valid_course_key")
    @patch("eox_lms.api.v1.views.get_course_grade_factory")
