...
class EdxappReplaceUsernameAPITest(TestCase):
    ...
    patch_permissions = patch('eox_lms.api.support.v1.permissions.EoxCoreSupportAPIPermission.has_permission', return_value=True)
    ...
    @patch_permissions
    @patch('eox_lms.api.support.v1.views.replace_username_cs_user')
    @patch('eox_lms.api.support.v1.serializers.UserSignupSource')
    @patch('eox_lms.api.support.v1.views.get_edxapp_user')
    @patch('eox_lms.api.support.v1.views.EdxappUserReadOnlySerializer')
