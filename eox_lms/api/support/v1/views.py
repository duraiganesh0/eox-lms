...
from eox_lms.api.support.v1.permissions import EoxCoreSupportAPIPermission
from eox_lms.api.support.v1.serializers import WrittableEdxappRemoveUserSerializer, WrittableEdxappUsernameSerializer
from eox_lms.api.v1.serializers import EdxappUserReadOnlySerializer
from eox_lms.api.v1.views import UserQueryMixin
from eox_lms.edxapp_wrapper.bearer_authentication import BearerAuthentication
from eox_lms.edxapp_wrapper.comments_service_users import replace_username_cs_user
from eox_lms.edxapp_wrapper.users import delete_edxapp_user, get_edxapp_user
...
class EdxappUser(UserQueryMixin, APIView):
    ...
    def delete(self, request, *args, **kwargs):  # pylint: disable=too-many-locals
        ...
        **Requests**:
            DELETE <domain>/eox-lms/support-api/v1/user/
...
class EdxappReplaceUsername(UserQueryMixin, APIView):
    ...
    def patch(self, request, *args, **kwargs):
        ...
        **Requests**:
            PATCH <domain>/eox-lms/support-api/v1/replace-username/
